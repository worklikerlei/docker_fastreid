...
def default_argument_parser():
    ...
    # parser.add_argument("--config-file", default="./configs/VehicleID/moco_R50-ibn.yml", metavar="FILE", help="path to config file")
    parser.add_argument("--config-file", default="./configs/VeRi/norm_CE_L1.yml", metavar="FILE", help="path to config file")
    # parser.add_argument("--config-file", default="./configs/cuhk03/sbs_R50-ibn_finetune.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
