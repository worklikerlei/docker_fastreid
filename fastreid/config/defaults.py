...
# MOCO Loss options
_C.MODEL.LOSSES.MOCO = CN()
_C.MODEL.LOSSES.MOCO.SCALE = 1.0
_C.MODEL.LOSSES.MOCO.TYPE = "triplet"

# MOCO contrastive LOSS options
_C.MODEL.LOSSES.MOCOCONT = CN()
_C.MODEL.LOSSES.MOCOCONT.SCALE = 1.0

# MaxCone Loss options
_C.MODEL.LOSSES.MAXCONE = CN()
_C.MODEL.LOSSES.MAXCONE.SCALE = 1.0
_C.MODEL.LOSSES.MAXCONE.TEMP = 0.05
_C.MODEL.LOSSES.MAXCONE.TYPE = 'all_he'
...
# MOCO queue size control
_C.MODEL.NUM_FEAT_PER_ID = 1
